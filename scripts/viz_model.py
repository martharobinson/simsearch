...
MODEL_DIR = os.path.join(
    os.path.dirname(__file__), "../models/clip_vit_lora_lightning/final_lora"
)
OUTPUT_PATH = os.path.join(
    os.path.dirname(__file__), "../diagrams/lora_model_architecture"
)
...
print(
    summary(
        lora_model,
        input_data={"pixel_values": dummy_input},
        depth=3,
        col_names=[
            "input_size",
            "output_size",
